...
const SPELLS: Dictionary = {
	...
	# ---- Roster expansion — one-line mechanics per entry.
	"force_lance": {
		"name": "Force Lance", "school": "conjurations",
		"mp": 4, "min_dmg": 3, "max_dmg": 15, "difficulty": 4,
		"targeting": "single", "range": 5, "effect": "damage",
		"color": Color(0.85, 0.80, 0.95),
		"desc": "A blunt pulse of force. Hits hard at short range.",
	},
	"sandblast": {
		"name": "Sandblast", "school": "earth",
		"mp": 1, "min_dmg": 2, "max_dmg": 10, "difficulty": 1,
		"targeting": "single", "range": 2, "effect": "damage",
		"color": Color(0.80, 0.65, 0.40),
		"desc": "A burst of grit. Cheap, close-range, scales with Earth skill.",
	},
	"lee_deconstruct": {
		"name": "Lee's Rapid Deconstruction", "school": "earth", "school2": "conjurations",
		"mp": 5, "min_dmg": 3, "max_dmg": 30, "difficulty": 5,
		"targeting": "area", "range": 6, "radius": 2, "effect": "damage",
		"color": Color(0.70, 0.55, 0.35),
		"desc": "Targets a stone wall or statue; shatters it into lethal shrapnel.",
	},
	"bolt_of_draining": {
		"name": "Bolt of Draining", "school": "necromancy",
		"mp": 5, "min_dmg": 3, "max_dmg": 22, "difficulty": 5,
		"targeting": "single", "range": 7, "effect": "damage",
		"color": Color(0.55, 0.15, 0.55),
		"desc": "A lance of death-energy. Bypasses ordinary armour.",
	},
	"haunt": {
		"name": "Haunt", "school": "necromancy", "school2": "summonings",
		"mp": 7, "min_dmg": 0, "max_dmg": 0, "difficulty": 7,
		"targeting": "area", "range": 6, "radius": 0, "effect": "summon_ghosts",
		"color": Color(0.45, 0.20, 0.60),
		"desc": "Spectral attackers harass the target — and curse you while they last.",
	},
	"borgnjor_vile_clutch": {
		"name": "Borgnjor's Vile Clutch", "school": "necromancy", "school2": "earth",
		"mp": 6, "min_dmg": 4, "max_dmg": 20, "difficulty": 5,
		"targeting": "area", "range": 5, "radius": 2, "effect": "damage",
		"color": Color(0.35, 0.25, 0.15),
		"desc": "Corpse-hands burst from the ground, damaging and rooting foes.",
	},
	"excruciating_wounds": {
		"name": "Excruciating Wounds", "school": "necromancy", "school2": "hexes",
		"mp": 3, "min_dmg": 0, "max_dmg": 0, "difficulty": 5,
		"targeting": "self", "range": 0, "effect": "brand_weapon_pain",
		"color": Color(0.55, 0.05, 0.25),
		"desc": "Imbues your current weapon with a temporary pain brand.",
	},
	"ignite_poison": {
		"name": "Ignite Poison", "school": "fire", "school2": "alchemy",
		"mp": 4, "min_dmg": 5, "max_dmg": 25, "difficulty": 3,
		"targeting": "area", "range": 0, "radius": 5, "effect": "ignite_poison",
		"color": Color(1.0, 0.55, 0.15),
		"desc": "Detonates every poisoned foe and poison cloud in sight.",
	},
	"olgreb_toxic_radiance": {
		"name": "Olgreb's Toxic Radiance", "school": "alchemy",
		"mp": 4, "min_dmg": 2, "max_dmg": 14, "difficulty": 4,
		"targeting": "area", "range": 0, "radius": 7, "effect": "poison_aura",
		"color": Color(0.55, 0.85, 0.25),
		"desc": "A green halo burns visible foes with building poison doses.",
	},
	"cause_fear": {
		"name": "Cause Fear", "school": "hexes",
		"mp": 4, "min_dmg": 0, "max_dmg": 0, "difficulty": 4,
		"targeting": "area", "range": 0, "radius": 6, "effect": "mass_fear",
		"color": Color(0.75, 0.30, 0.60),
		"desc": "Every visible foe with a mind flees if its willpower fails.",
	},
	"summon_imp": {
		"name": "Summon Imp", "school": "summonings",
		"mp": 2, "min_dmg": 0, "max_dmg": 0, "difficulty": 3,
		"targeting": "self", "range": 0, "effect": "summon_imp",
		"color": Color(0.95, 0.40, 0.30),
		"desc": "Calls a minor devil to harry nearby foes.",
	},
	"call_canine_familiar": {
		"name": "Call Canine Familiar", "school": "summonings",
		"mp": 3, "min_dmg": 0, "max_dmg": 0, "difficulty": 4,
		"targeting": "self", "range": 0, "effect": "summon_wolf",
		"color": Color(0.70, 0.55, 0.35),
		"desc": "Summons a wolf companion bound to your side.",
	},
	"summon_demon": {
		"name": "Summon Demon", "school": "summonings",
		"mp": 5, "min_dmg": 0, "max_dmg": 0, "difficulty": 6,
		"targeting": "self", "range": 0, "effect": "summon_demon_mid",
		"color": Color(0.85, 0.25, 0.25),
		"desc": "Pulls a greater demon through the veil for a short time.",
	},
	"discharge": {
		"name": "Discharge", "school": "air",
		"mp": 3, "min_dmg": 3, "max_dmg": 18, "difficulty": 3,
		"targeting": "area", "range": 0, "radius": 1, "effect": "damage",
		"color": Color(1.00, 1.00, 0.50),
		"desc": "Arcing electricity leaps to adjacent enemies.",
	},
	"polar_vortex": {
		"name": "Polar Vortex", "school": "cold", "school2": "air",
		"mp": 8, "min_dmg": 5, "max_dmg": 40, "difficulty": 7,
		"targeting": "area", "range": 0, "radius": 4, "effect": "damage",
		"color": Color(0.55, 0.90, 1.00),
		"desc": "A blizzard churns around you, scourging everything in sight.",
	},
	"frozen_ramparts": {
		"name": "Frozen Ramparts", "school": "cold",
		"mp": 3, "min_dmg": 0, "max_dmg": 0, "difficulty": 3,
		"targeting": "self", "range": 0, "effect": "frozen_ramparts",
		"color": Color(0.75, 0.90, 1.00),
		"desc": "Sheets adjacent walls in killing frost.",
	},
	"gravitas": {
		"name": "Gravitas", "school": "translocations",
		"mp": 3, "min_dmg": 0, "max_dmg": 0, "difficulty": 3,
		"targeting": "area", "range": 6, "radius": 2, "effect": "gravitas",
		"color": Color(0.50, 0.40, 0.75),
		"desc": "A point of false gravity yanks nearby foes toward its centre.",
	},
	"teleport_other": {
		"name": "Teleport Other", "school": "translocations",
		"mp": 3, "min_dmg": 0, "max_dmg": 0, "difficulty": 3,
		"targeting": "single", "range": 6, "effect": "teleport_other",
		"color": Color(0.65, 0.50, 0.95),
		"desc": "Flings one foe to a random spot on this floor.",
	},
	"passwall": {
		"name": "Passwall", "school": "earth", "school2": "translocations",
		"mp": 3, "min_dmg": 0, "max_dmg": 0, "difficulty": 3,
		"targeting": "self", "range": 0, "effect": "passwall",
		"color": Color(0.65, 0.55, 0.35),
		"desc": "Slip through the nearest wall to the open floor on its far side.",
	},
}
...
const SCHOOL_SPELLS: Dictionary = {
	...
	"necromancy": [
		...
		{"id": "bolt_of_draining", "min_level": 5},
		{"id": "excruciating_wounds", "min_level": 5},
		{"id": "agony", "min_level": 5},
		{"id": "borgnjor_vile_clutch", "min_level": 5},
		{"id": "haunt", "min_level": 7},
	],
	"alchemy": [
		{"id": "olgreb_toxic_radiance", "min_level": 4},
		{"id": "ignite_poison", "min_level": 3},
	],
	"hexes": [
		{"id": "slow", "min_level": 1},
		{"id": "confuse", "min_level": 3},
		{"id": "cause_fear", "min_level": 4},
		{"id": "petrify", "min_level": 4},
	],
	"translocations": [
		{"id": "blink", "min_level": 2},
		{"id": "gravitas", "min_level": 3},
		{"id": "teleport_other", "min_level": 3},
		{"id": "passage", "min_level": 4},
		{"id": "passwall", "min_level": 3},
	],
	"summonings": [
		{"id": "summon_imp", "min_level": 3},
		{"id": "call_canine_familiar", "min_level": 4},
		{"id": "summon_demon", "min_level": 6},
	],
}
