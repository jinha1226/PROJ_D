...
# Default starter list — DCSS basics (Fighter / Conjurer / Hunter). Advanced
# classes appear in extended selection UI once their unlocked flag is true.
const ACTIVE_BASE_IDS: Array = ["fighter", "conjurer", "hunter"]
...
const _ALL_CLASSES: Array = [
	...
	_HUNTER, _BRIGAND,
	_CONJURER, _ENCHANTER, _NECROMANCER, _SUMMONER,
