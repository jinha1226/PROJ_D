...
const DISTRICTS: Dictionary = {
	...
	"orc_mines": [
		...
		{"name": "Crusher Lane",     "rect": [6, 36, 16, 12],  "role": "hazard",   "profile": "machinery", "skill": "tactics"},
	...
	"elven_halls": [
		...
		{"name": "Lower Gardens",     "rect": [4, 34, 18, 14],  "role": "skill",    "profile": "garden",  "skill": "stealth"},
		{"name": "Silent Library",    "rect": [4, 18, 20, 14],  "role": "reward",   "profile": "library", "skill": "magery"},
		{"name": "Mirror Court",      "rect": [24, 22, 18, 16], "role": "pressure", "profile": "mirror",  "skill": "tactics"},
	...
	"abyss": [
		...
		{"name": "Time-Slip Gallery",  "rect": [34, 16, 16, 12], "role": "hazard",  "profile": "shift",  "skill": "tactics"},
	...
	"ice_caves": [
		...
		{"name": "Reflective Archive", "rect": [4, 26, 16, 14],  "role": "reward", "profile": "mirror", "skill": "tactics"},
	...
	"infernal": [
		...
		{"name": "Lava Crucible",   "rect": [16, 24, 22, 16], "role": "hazard", "profile": "machinery", "skill": "tactics"},
