...
const _FALLBACK_REGULARS: Dictionary = {
	...
	"wizlab":    ["ugly_thing", "boggart", "deep_elf_sorcerer", "orc_sorcerer"],
	"trove":     ["guardian_mummy", "iron_golem", "orc_warrior"],
	"labyrinth": ["minotaur"],
	"gauntlet":  ["minotaur", "ogre", "hell_hound", "redback"],
	"desolation":["salamander", "orc_warrior", "orc_knight", "stone_giant"],
	# Hell sub-branches.
