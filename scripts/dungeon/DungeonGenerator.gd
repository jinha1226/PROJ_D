...
enum TileType { WALL, FLOOR, DOOR_OPEN, DOOR_CLOSED, STAIRS_DOWN, STAIRS_UP, WATER, LAVA, TRAP, BRANCH_ENTRANCE, SHOP, ALTAR, TREE, ACID, CRYSTAL_WALL, GLASS_WALL, TRANSLUCENT_STONE }
