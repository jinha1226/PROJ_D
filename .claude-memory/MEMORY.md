...
- [DCSS port backlog](dcss_port_backlog.md) — checklist of remaining DCSS systems; next-session top-of-stack: Amulet roster → multi-stat rings/randart → player willpower → status effect breadth. Gods deferred.
